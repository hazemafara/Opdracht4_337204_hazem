...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO Afspraak (color1, color2, color3, color4, phone, email, appointment, treatment1, treatment2, treatment3, timestamp) 
    VALUES (:color1, :color2, :color3, :color4, :phone, :email, :appointment, :treatment1, :treatment2, :treatment3, :timestamp)";
